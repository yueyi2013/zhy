<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfMemberList.aspx.cs" Inherits="Web.admin.site.mem.wfMemberList" %>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PsnLevelId" HeaderText="会员等级">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="MemMail" HeaderText="验证邮箱">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>                                            
