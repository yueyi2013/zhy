<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfAdTaskList.aspx.cs" Inherits="Web.admin.task.wfAdTaskList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="VTId" OnRowCommand="MstGridView_RowCommand"
            ...
            <ContentTemplate>
                ...
                <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtVSCode" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                            用户名： <asp:HiddenField ID="hfVTId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                           <asp:TextBox id="txtVTUserName" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtVTPassword" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtVTProxy" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
