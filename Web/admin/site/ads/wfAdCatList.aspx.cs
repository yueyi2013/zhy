...
{
    public partial class wfAdCatList : BasePage
    {
        ...
        {
            int id = ConvertInt32(this.hfAdCategoryId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.AdCategoryName = this.txtAdCategoryName.Text;
            model.AdCategoryDesc = this.txtAdCategoryDesc.Text;
        ...
        {
            ZHY.BLL.AdCategory bll = new ZHY.BLL.AdCategory();
            ZHY.Model.AdCategory model = bll.GetModel(ID);
            if (model != null)
            {
                model.AdCategoryName = this.txtAdCategoryName.Text;
                model.AdCategoryDesc = this.txtAdCategoryDesc.Text;
        ...
        {
            this.hfAdCategoryId.Value = "0";
            this.txtAdCategoryName.Text = "";
            this.txtAdCategoryDesc.Text = "";
        ...
        {
            ZHY.BLL.AdCategory bll = new ZHY.BLL.AdCategory();
            ZHY.Model.AdCategory model = bll.GetModel(rssId);
            this.hfAdCategoryId.Value = model.AdCategoryId.ToString();
            this.txtAdCategoryName.Text = model.AdCategoryName;
            this.txtAdCategoryDesc.Text = model.AdCategoryDesc;
