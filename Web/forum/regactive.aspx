...
<div class="login_cont03">
    ...
    <p class="cont">您的信息已经成功提交，激活链接已发送到您的邮箱 <em style="color:#f00; font-style:normal;">z******@msn.com</em>.
...
<div class="login_cont04">
	...
	<ul>
		...
		<li>如果您确认邮箱地址正确，可以请求<a id="aReact" href="/account/regactive">再次发送激活码</a></li>
	</ul>
</div>
