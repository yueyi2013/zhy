...
{
    public partial class wfSiteFileList : BasePage
    {
        ...
        {
            int id = ConvertInt32(this.hfSiteFileId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.SiteFileName = this.txtSiteFileName.Text;
            model.SiteFileTypeId = int.Parse(this.ddlSiteFile.Text);
            model.SiteFilePath = this.txtSiteFilePath.Text;
        ...
        {
            ZHY.BLL.SiteFile bll = new ZHY.BLL.SiteFile();
            ZHY.Model.SiteFile model = bll.GetModel(ID);
            if (model != null)
            {
                model.SiteFileName = this.txtSiteFileName.Text;
                model.SiteFileTypeId = int.Parse(this.ddlSiteFile.Text);
        ...
        {
            this.hfSiteFileId.Value = "0";
            this.txtSiteFileName.Text = "";
            this.txtSiteFilePath.Text = "";
        ...
        {
            ZHY.BLL.SiteFile bll = new ZHY.BLL.SiteFile();
            ZHY.Model.SiteFile model = bll.GetModel(rId);
            this.hfSiteFileId.Value = model.SiteFileId.ToString();
            this.txtSiteFileName.Text = model.SiteFileName;
            this.txtSiteFileDesc.Text = model.SiteFileDesc;
        }
        #endregion
    }
}