/****** Object:  Table [dbo].[ArticleCategory]    Script Date: 06/24/2013 19:59:26 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[ArticleCategory] ADD  DEFAULT (getdate()) FOR [CreateAt]
GO

ALTER TABLE [dbo].[ArticleCategory] ADD  DEFAULT (getdate()) FOR [UpdateDT]
GO
