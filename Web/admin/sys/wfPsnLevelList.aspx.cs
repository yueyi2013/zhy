...
{
    public partial class wfPsnLevelList : BasePage
    {
        ...
        {
            ZHY.BLL.PersonLevel bll = new ZHY.BLL.PersonLevel();
        ...
        {
            int id = ConvertInt32(this.hfPsnLevelId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.PsnLevelCode = this.txtPsnLevelCode.Text;
            model.PsnLevelName = this.txtPsnLevelName.Text;
            model.PsnLevelDesc = this.txtPsnLevelDesc.Text;
            model.PsnLevelId = int.Parse(this.ddlLevelType.SelectedItem.Value);
        ...
        {
            ZHY.BLL.PersonLevel bll = new ZHY.BLL.PersonLevel();
            ZHY.Model.PersonLevel model = bll.GetModel(ID);
            if (model != null)
            {
                model.PsnLevelCode = this.txtPsnLevelCode.Text;
                model.PsnLevelName = this.txtPsnLevelName.Text;
        ...
        {
            this.hfPsnLevelId.Value = "0";
            this.txtPsnLevelName.Text = "";
            this.txtPsnLevelCode.Text = "";
            this.txtPsnLevelDesc.Text = "";
        }
        ...
        {
            ZHY.BLL.PersonLevel bll = new ZHY.BLL.PersonLevel();
            ZHY.Model.PersonLevel model = bll.GetModel(rssId);
            this.hfPsnLevelId.Value = model.PsnLevelId.ToString();
            this.txtPsnLevelCode.Text = model.PsnLevelCode;
            this.txtPsnLevelName.Text = model.PsnLevelName;
            this.txtPsnLevelDesc.Text = model.PsnLevelDesc;
        }
        #endregion
    }
}