<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfNewsTopList.aspx.cs" Inherits="Web.admin.site.news.wfNewsTopList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="NTId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NTTitle" HeaderText="新闻标题">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NTAuthor" HeaderText="作者">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtNTTitle" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                    ...
                    <tr>
                        <td height="25" width="30%" align="right">
                            内容： <asp:HiddenField ID="hfNTId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <FTB:FreeTextBox ID="ftContent" runat="server" Height="250" Width="620"/>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
