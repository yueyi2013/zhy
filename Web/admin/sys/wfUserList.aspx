<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfUserList.aspx.cs" Inherits="Web.admin.sys.wfUserList" %>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UserPsw" HeaderText="密码">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UserMedium" HeaderText="中间人">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UserUnitTel" HeaderText="单位电话">
                                                <ItemStyle Width="200px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UserShotNum" HeaderText="短号">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UserMobile" HeaderText="移动电话">
                                                <ItemStyle Width="200px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UserRealName" HeaderText="状态">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="RoleID" HeaderText="身份">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
            ...
            <ContentTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
	                    ...
	                    <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlRoleLList" runat="server" DataTextField="RoleName" DataValueField="RoleID" Width="200px">
                            </asp:DropDownList>
	                    </td>
                    </tr>
	                <tr>
	                ...
	                <tr>
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtUserMedium" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtUserUnitTel" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtUserShotNum" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtUserMobile" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
                    ...
                    <tr>
                        <td height="25" width="20%" align="right">
                            状态:<asp:HiddenField ID="hfUserID" runat="server" Value="0" />
                        </td>
                        <td height="25" width="*" align="left">
