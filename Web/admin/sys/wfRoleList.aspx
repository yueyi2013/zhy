<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfRoleList.aspx.cs" Inherits="Web.admin.sys.wfRoleList" %>
        ...
        <asp:UpdatePanel ID="MyUpdatePanelPanelBody" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
	                ...
	                <tr>
	                    <td height="25" width="20%" align="right">
		                    角色描述:<asp:HiddenField ID="hfRoleId" runat="server" />
	                    </td>
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtRoleDes" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
	                    </td>
                    </tr>
                </table>
            </ContentTemplate>
