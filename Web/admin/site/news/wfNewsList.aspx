<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfNewsList.aspx.cs" Inherits="Web.admin.site.news.wfNewsList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="NewsId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NewsAuthor" HeaderText="作者">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NewsPubDate" HeaderText="发布日期">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NewsCategory" HeaderText="种类">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NewsSource" HeaderText="来源">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="NewsStatus" HeaderText="状态">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
            ...
            <ContentTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlNewsCategory" runat="server" Width="200px" DataTextField="NewsCategoryName" DataValueField="NewsCategoryId">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtNewsIndustry" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    
                    <tr>
                        <td height="25" width="30%" align="right">
                            内容： <asp:HiddenField ID="hfNewsId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
