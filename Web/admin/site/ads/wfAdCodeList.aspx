<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfAdCodeList.aspx.cs" Inherits="Web.admin.site.ads.wfAdCodeList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="AdCodeId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="AdCodeCont" HeaderText="内容">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AdCodeDesc" HeaderText="代码描述">
                                                <ItemStyle Width="200px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AdDefault" HeaderText=" 默认">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
        ...
        <asp:UpdatePanel ID="MyUpdatePanelPanelBody" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="25" width="80px" align="right">
                           广告：
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlAd" runat="server" DataTextField="AdName" DataValueField="AdId">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtAdCodeCont" runat="server" Height="200" Width="350px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtCodeDesc" runat="server" Width="350px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" align="right">
                            默认代码： <asp:HiddenField ID="hfAdCodeId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:RadioButtonList ID="rbAdDefault" runat="server" RepeatDirection="Horizontal">
