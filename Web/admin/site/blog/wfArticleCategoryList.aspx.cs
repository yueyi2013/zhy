...
{
    public partial class wfArticleCategoryList : BasePage
    {
        ...
        {
            int ntId = ConvertInt32(this.hfArCatId.Value, 0);
            if (ntId == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.ACName = this.txtArCatName.Text;
            model.ACDesc = this.txtArCatDesc.Text;
        ...
        {
            ZHY.BLL.ArticleCategory bll = new ZHY.BLL.ArticleCategory();
            ZHY.Model.ArticleCategory model = bll.GetModel(ID);
            if (model != null)
            {
                model.ACName = this.txtArCatName.Text;
                model.ACDesc = this.txtArCatDesc.Text;
        ...
        {
            this.hfArCatId.Value = "0";
            this.txtArCatName.Text = "";
            this.txtArCatDesc.Text = "";
        }
        ...
        {
            ZHY.BLL.ArticleCategory bll = new ZHY.BLL.ArticleCategory();
            ZHY.Model.ArticleCategory model = bll.GetModel(rssId);
            this.hfArCatId.Value = model.ACId.ToString();
            this.txtArCatName.Text = model.ACName;
            this.txtArCatDesc.Text = model.ACDesc;
        }
        #endregion
    }
}