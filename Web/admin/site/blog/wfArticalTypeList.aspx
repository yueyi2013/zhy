<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfArticalTypeList.aspx.cs" Inherits="Web.admin.site.blog.wfArticalTypeList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="ATId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ATName" HeaderText="文章类型">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ATDesc" HeaderText="类型描述">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtArTypeName" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:HiddenField ID="hfArTypeId" runat="server" Value="0" />
                            <asp:TextBox ID="txtArTypeDesc" runat="server" Width="200px" TextMode="MultiLine" ></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
