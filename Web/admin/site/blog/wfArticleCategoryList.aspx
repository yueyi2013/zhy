<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfArticleCategoryList.aspx.cs" Inherits="Web.admin.site.blog.wfArticleCategoryList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="ACId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ACName" HeaderText="类别名称">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACDesc" HeaderText="类别描述">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtArCatName" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:HiddenField ID="hfArCatId" runat="server"  Value="0"/>
                            <asp:TextBox ID="txtArCatDesc" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
