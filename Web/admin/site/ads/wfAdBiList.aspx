<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfAdBiList.aspx.cs" Inherits="Web.admin.site.ads.wfAdBiList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="AdBgId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="AdBgCode" HeaderText="计费名">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AdBgDesc" HeaderText="计费描述">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="25" width="20%" align="right">
                           计费代码：<asp:HiddenField ID="hfAdBgId" runat="server" Value="0"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtAdBgDesc" runat="server" Height="150px" Width="300px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
