...
{
    public partial class wfAdSiteList : BasePage
    {
        ...
        {
            ZHY.BLL.VirtualSite bll = new ZHY.BLL.VirtualSite();
        ...
        {
            int id = ConvertInt32(this.hfVSId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.VSName = this.txtVSName.Text;
            model.VSURL = this.txtVSURL.Text;
        ...
        {
            ZHY.BLL.VirtualSite bll = new ZHY.BLL.VirtualSite();
            ZHY.Model.VirtualSite model = bll.GetModel(ID);
            if (model != null)
            {
                model.VSCode = this.txtVSCode.Text;
                model.VSName = this.txtVSName.Text;
        ...
        private void InitData(int id)
        {
            ZHY.BLL.VirtualSite bll = new ZHY.BLL.VirtualSite();
            ZHY.Model.VirtualSite model = bll.GetModel(id);
            this.hfVSId.Value = model.VSId.ToString();
            this.txtVSName.Text = model.VSName;
            this.txtVSURL.Text = model.VSURL;
