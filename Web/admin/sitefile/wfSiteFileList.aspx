<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfSiteFileList.aspx.cs" Inherits="Web.admin.sitefile.wfSiteFileList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="SiteFileId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SiteFileName" HeaderText="文件名">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SiteFilePath" HeaderText="文件路径">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SiteFileDesc" HeaderText="文件描述">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFileName" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
                    <tr>
	                    <td height="25" width="20%" align="right">
	                    ...
	                    <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlSiteFile" runat="server" DataTextField="SiteFileTypeName" DataValueField="SiteFileTypeId">
                            </asp:DropDownList>
	                    </td>
                    </tr>
                     <tr>
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFilePath" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
		                    文件描述:<asp:HiddenField ID="hfSiteFileId" runat="server" />
	                    </td>
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFileDesc" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
	                    </td>
                    </tr>
                </table>
            </ContentTemplate>
