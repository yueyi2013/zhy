<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfSiteFlash.aspx.cs" Inherits="Web.admin.site.ads.wfSiteFlash" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<fieldset style="width: 800px">
    <legend>网站Flash</legend>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="SFId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SFConTitle" HeaderText="标题">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SFPicPath" HeaderText="图片路径">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SFDetailsURL" HeaderText="链接">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SFOrder" HeaderText="排序">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtSFConTitle" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtSFPicPath" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtSFDetailsURL" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                            排序： <asp:HiddenField ID="hfSFId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtSFOrder" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
