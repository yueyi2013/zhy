...
{
    public partial class wfSiteFileTypeList : BasePage
    {
        ...
        {
            ZHY.BLL.SiteFileType bll = new ZHY.BLL.SiteFileType();
        ...
        {
            int id = ConvertInt32(this.hfSiteFileTypeId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow gvr in MstGridView.Rows)
            {
                ...
                if (chk.Checked)
                {
                    ZHY.BLL.SiteFile bll = new ZHY.BLL.SiteFile();
        ...
        private void Add()
        {
            ...
            model.SiteFileTypeName = this.txtSiteFileTypeName.Text;
            model.SiteFileTypeIcon = this.txtSiteFileTypeIcon.Text;
            model.SiteFileTypeDesc = this.txtSiteFileTypeDesc.Text;
        ...
        {
            ZHY.BLL.SiteFileType bll = new ZHY.BLL.SiteFileType();
            ZHY.Model.SiteFileType model = bll.GetModel(ID);
            if (model != null)
            {
                model.SiteFileTypeName = this.txtSiteFileTypeName.Text;
                model.SiteFileTypeIcon = this.txtSiteFileTypeIcon.Text;
        ...
        {
            this.hfSiteFileTypeId.Value = "0";
            this.txtSiteFileTypeName.Text = "";
            this.txtSiteFileTypeIcon.Text = "";
            this.txtSiteFileTypeDesc.Text = "";
        }

        /// <summary>
        /// 初始化数据控件
        /// </summary>
        private void InitData(int rId)
        {
            ZHY.BLL.SiteFileType bll = new ZHY.BLL.SiteFileType();
            ZHY.Model.SiteFileType model = bll.GetModel(rId);
            this.hfSiteFileTypeId.Value = model.SiteFileTypeId.ToString();
            this.txtSiteFileTypeName.Text = model.SiteFileTypeName;
            this.txtSiteFileTypeIcon.Text = model.SiteFileTypeIcon;
            this.txtSiteFileTypeDesc.Text = model.SiteFileTypeDesc;
        }
        #endregion
    }
}