<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfAdCatList.aspx.cs" Inherits="Web.admin.site.ads.wfAdCatList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="AdCategoryId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="AdCategoryName" HeaderText="类型名">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="AdCategoryDesc" HeaderText="类型描述">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="25" width="20%" align="right">
                           类型名：<asp:HiddenField ID="hfAdCategoryId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtAdCategoryName" runat="server" Width="250px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox id="txtAdCategoryDesc" runat="server" Width="250px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" align="right">
