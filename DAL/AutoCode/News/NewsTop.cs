...
namespace ZHY.DAL
{
	...
	public partial class NewsTop
	{
		...
		public bool Add(ZHY.Model.NewsTop model)
		{
			...
			parameters[0].Value = model.NTId;
			parameters[1].Value = model.NTTitle;
			parameters[2].Value = model.NTAuthor;
			parameters[3].Value = model.NTPubDate;
			parameters[4].Value = model.NTContent;
