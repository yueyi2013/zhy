<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfRightConfig.aspx.cs" Inherits="Web.admin.sys.wfRightConfig" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="RiCId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FunID" HeaderText="功能编号">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="RoleID" HeaderText="角色编号">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="RiCIdStatus" HeaderText="状态">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlFunlist" runat="server" DataValueField="FunID" DataTextField="FunName" Width="200">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:DropDownList ID="ddlRoleLst" runat="server" DataValueField="RoleID" DataTextField="RoleName" Width="200">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
                            状态： <asp:HiddenField ID="hfRiCId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:RadioButtonList ID="ricStatus" runat="server" RepeatDirection="Horizontal">
