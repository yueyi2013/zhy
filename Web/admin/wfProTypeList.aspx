<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main.Master" AutoEventWireup="true"
    CodeBehind="wfProTypeList.aspx.cs" Inherits="ZHY.Web.admin.wfProTypeList" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RoleName" HeaderText="商品类型名称">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="RoleDes" HeaderText="商品类型描述">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="RoleDes" HeaderText="状态">
                    ...
                    <ContentTemplate>
                        <table cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtProTypeName" runat="server" Width="150px"></asp:TextBox>
                                    <asp:TextBox ID="txtProTypeID" runat="server" Width="150px" Visible="false"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtProTypeDes" runat="server" Width="150px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
