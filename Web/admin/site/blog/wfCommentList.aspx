<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfCommentList.aspx.cs" Inherits="Web.admin.site.blog.wfCommentList" %>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ArId" HeaderText="文章编号">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACMCmtPsn" HeaderText="评论人">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACMContent" HeaderText="评论内容">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACMDate" HeaderText="评论日期">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACMTop" HeaderText="顶">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ACMDown" HeaderText="踩">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="25" width="30%" align="right">
                            评论内容： <asp:HiddenField ID="hfACMId" runat="server" Value="0"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            <asp:RadioButtonList ID="rbStatus" runat="server">
                                <asp:ListItem Selected="True" Value="A" Text="正常"></asp:ListItem>
                                <asp:ListItem Value="I" Text="禁用"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
