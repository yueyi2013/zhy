...
{
    public partial class wfPsnLevTypeList : BasePage
    {
        ...
        {
            ZHY.BLL.PsnLevelType bll = new ZHY.BLL.PsnLevelType();
        ...
        {
            int id = ConvertInt32(this.hfPsnLevelTypeId.Value, 0);
            if (id == 0)
            {
                Add();
                InitDataClear();
        ...
        private void Add()
        {
            ...
            model.PsnLevelTypeName = this.txtPsnLevelTypeName.Text;
            model.PsnLevelTypeDesc = this.txtPsnLevelTypeDesc.Text;
        ...
        {
            ZHY.BLL.PsnLevelType bll = new ZHY.BLL.PsnLevelType();
            ZHY.Model.PsnLevelType model = bll.GetModel(ID);
            if (model != null)
            {
                model.PsnLevelTypeName = this.txtPsnLevelTypeName.Text;
                model.PsnLevelTypeDesc = this.txtPsnLevelTypeDesc.Text;
        ...
        {
            this.hfPsnLevelTypeId.Value = "0";
            this.txtPsnLevelTypeName.Text = "";
            this.txtPsnLevelTypeDesc.Text = "";
        }
        ...
        {
            ZHY.BLL.PsnLevelType bll = new ZHY.BLL.PsnLevelType();
            ZHY.Model.PsnLevelType model = bll.GetModel(rssId);
            this.hfPsnLevelTypeId.Value = model.PsnLevelTypeId.ToString();
            this.txtPsnLevelTypeName.Text = model.PsnLevelTypeName;
            this.txtPsnLevelTypeDesc.Text = model.PsnLevelTypeDesc;
        }
        #endregion
    }
}