<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfMemMenuList.aspx.cs" Inherits="Web.admin.site.mem.wfMemMenuList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="MMId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MMName" HeaderText="菜单名">
                                                <ItemStyle Width="300px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="MMOrder" HeaderText="排序">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="MMPicPath" HeaderText="图标路径">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="MMDesc" HeaderText="描述">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="MMStatus" HeaderText="状态">
                                                <ItemStyle Width="100px" />
                                            </asp:BoundField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
                        <td height="25" width="20%" align="right">
                            菜单名：<asp:HiddenField ID="hfMMId" runat="server" Value="0"/>
                        </td>
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtMMName" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="20%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtMMPicPath" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="20%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtMMOrder" runat="server" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="20%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:TextBox ID="txtMMDesc" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="20%" align="right">
                        ...
                        <td height="25" width="*" align="left">
                            <asp:RadioButtonList ID="rbMMStatus" runat="server" RepeatDirection="Horizontal">
