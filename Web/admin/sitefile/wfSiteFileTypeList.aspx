<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Main0.Master" AutoEventWireup="true" CodeBehind="wfSiteFileTypeList.aspx.cs" Inherits="Web.admin.sitefile.wfSiteFileTypeList" %>
                            ...
                            <asp:UpdatePanel ID="MyUpdatePanelBody" runat="server" UpdateMode="Conditional">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="MstGridView" runat="server" AutoGenerateColumns="False" Width="98%"
                                        AllowPaging="false" DataKeyNames="SiteFileTypeId" OnRowCommand="MstGridView_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SiteFileTypeName" HeaderText="文件类型名">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SiteFileTypeIcon" HeaderText="类型图标">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SiteFileTypeDesc" HeaderText="描述">
                                                <ItemStyle Width="150px" />
                                            </asp:BoundField>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tr>
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFileTypeName" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
                    <tr>
	                    <td height="25" width="20%" align="right">
	                    ...
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFileTypeIcon" runat="server" Width="200px"></asp:TextBox>
	                    </td>
                    </tr>
	                <tr>
	                    <td height="25" width="20%" align="right">
		                    类型描述:<asp:HiddenField ID="hfSiteFileTypeId" runat="server" />
	                    </td>
	                    <td height="25" width="*" align="left">
		                    <asp:TextBox id="txtSiteFileTypeDesc" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
	                    </td>
                    </tr>
                </table>
            </ContentTemplate>
